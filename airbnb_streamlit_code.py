...
def datafr():
    df= pd.read_csv("C:\\Users\\USER PC\\OneDrive\\Desktop\\Projects\\AirBnB\\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:\\Users\\USER PC\\OneDrive\\Desktop\\Projects\\AirBnB\\Airbnbsample.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:\\Users\\USER PC\\OneDrive\\Desktop\\Projects\\AirBnB\\Airbnb.csv")
            return df_a
